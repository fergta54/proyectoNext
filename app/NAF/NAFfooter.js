...
export function NAFfooter() {
    return(
        <footer id="Footer" className="clearfix" role="contentinfo" style={{ backgroundColor: '#762d3d' }}>
            ...
            <aside id="custom_html-2" className="widget_text widget widget_custom_html">
              ...
              <div className="textwidget custom-html-widget">
                ...
                <div style={{ textAlign: 'center' }}>
                  ...
                  <h4 style={{ color: 'white' }}>Universidad Privada del Valle Bolivia</h4>
