export function FooterUniv() {
    return (
        <footer id="Footer" className="clearfix" role="contentinfo" style={{ backgroundColor: '#762d3d', marginBottom: '0' }}>
                  ...
                  <aside id="custom_html-2" className="widget_text widget widget_custom_html">
                    <div className="textwidget custom-html-widget">
                      <div style={{ textAlign: 'center' }}>
                        <h4 style={{ fontWeight: 600, color: 'white' }}>Universidad Privada del Valle Bolivia</h4>
                        <hr className="no_line" style={{ margin: '0 auto 5px auto' }} />
                        <p style={{ color: 'white' }}>Univalle - Bolivia</p>
                      </div>
                    </div>
                  </aside>
                </div>
        ...
        <div className="footer_copy">
          <div className="container">
            <div className="row">
              <div className="col-md-12">
                <div className="mcb-column-inner">
                  <a id="back_to_top" className="footer_button" href=""><i className="icon-up-open-big" aria-label="Back to top icon"></i></a>
                  <div className="copyright" style={{ color: 'white' }}>
                    © Univalle 2023 by FarFarAwayDevs | All Rights Reserved | Powered by React <svg
      viewBox="0 0 34 32"
      fill="currentColor"
      height="1em"
      width="1em"
    ...
    >
      ...
      />
                  ...
                  <ul className="social" role="navigation" aria-label="Social Menu"></ul>
                </div>
              </div>
            </div>
          </div>
